...
1. Изучил начальные условия. Популяция состоит из 13000 особей. В начальный момент времени: 113 особей инфицированы; 13 здоровая особь с иммунитетом; 
(13000 - 113 - 13) особей, воприимчивых к болезни. Задал коэффициент заболеваемости, равный 0,15, и коэффициент выздоровления, равный 0,02.
...
10. Собрал код программы воедино и получила следующее:
```
import math
import numpy as np
